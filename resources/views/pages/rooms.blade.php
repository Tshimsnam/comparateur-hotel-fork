      ...
      <div class="container">
        <div class="row site-hero-inner justify-content-center align-items-center">
          <div class="col-md-10 text-center" data-aos="fade">
            <h1 class="heading mb-3">Voir Hotel</h1>
            ...
            <form action="#">
              <div class="search-bar">
                <div class="input-group">
                  <form action="{{route('hotels.index')}}" method="get" onsubmit=handleSubmit(event)>
                    <input type="text" class="form-control" id="search_input" name="filter" placeholder="Rechercher par commune..." aria-label="Rechercher" aria-describedby="search-button">
    ...
    <section class="section">
      <div class="container">
        <div class="row justify-content-center text-center mb-5">
          <div class="col-md-7">
            <h2 class="heading" data-aos="fade-up" id="search_title">Nos hotels</h2>
        ...
        <div class="row " id="hotel_container">
          @forelse ($hotels as $hotel)
          <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up">
            <a href="{{route('hotels.show',$hotel->id)}}" class="room">
