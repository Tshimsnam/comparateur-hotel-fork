<div class="p-6 lg:p-8 bg-white border-b border-gray-200">
    ...
    <h1 class="mt-8 text-2xl font-medium text-gray-900">
        Bienvenu sur l'interface Admin de KinHotel
    </h1>
...
<div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
    <div>
        <div class="flex items-center">
            ...
            <h2 class="ms-3 text-xl font-semibold text-gray-900">
                <a href="{{route('showHotelAdmin')}}">Hotel</a>
            </h2>
        </div>

        <p class="mt-4 text-gray-500 text-sm leading-relaxed">
            Ici vous pouvez gerer les hotels
        </p>

        <p class="mt-4 text-sm">
            <a href="{{route('showHotelAdmin')}}" class="inline-flex items-center font-semibold text-indigo-700">
                Gerer
    ...
    <div>
        <div class="flex items-center">
            ...
            <h2 class="ms-3 text-xl font-semibold text-gray-900">
                <a href="{{route('chambres.index')}}">Chambre</a>
            </h2>
        </div>
        ...
        <p class="mt-4 text-sm">
            <a href="{{route('chambres.index')}}" class="inline-flex items-center font-semibold text-indigo-700">
                Gerer
