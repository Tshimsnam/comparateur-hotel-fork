    ...
    <header class="site-header js-site-header">
      <div class="container-fluid">
        <div class="row align-items-center">
          <div class="col-6 col-lg-4 site-logo" data-aos="fade"><a href="{{route('Accueil.index')}}">KinHotel.cd</a></div>
      ...
      <div class="container">
        <div class="row site-hero-inner justify-content-center align-items-center">
          <div class="col-md-10 text-center" data-aos="fade-up">
            <span class="custom-caption text-uppercase text-white d-block  mb-3">Bienvenue à Kinshasa <span class="fa fa-star text-primary"></span>KinHotel</span>
            <h1 class="heading">Choisisez où passé vos sejours</h1>
          </div>
        </div>
      </div>
            ...
            <form action="#">
              ...
              <div class="row">
                ...
                <div class="col-md-6 col-lg-3 align-self-end">
                  <button class="btn btn-primary btn-block text-white">Vérifier la disponibilité</button>
                </div>
              </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-12 col-lg-4 order-lg-1" data-aos="fade-up">
            ...
            <p><a href="#" class="btn btn-primary text-white py-2 mr-3">Voir plus</a> <span class="mr-3 font-family-serif"></p>
          </div>
    ...
    <section class="section">
      <div class="container">
        <div class="row justify-content-center text-center mb-5">
          <div class="col-md-7">
            <h2 class="heading" data-aos="fade-up">Nos Hotels</h2>
            <p data-aos="fade-up" data-aos-delay="100">Plus de 50 hotels homologués dans la Ville province de Kinshasa
              principalement dans la commune de Gombe, Limete, Lemba, Ngaliema & Lingwala.</p>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="home-slider major-caousel owl-carousel mb-5" data-aos="fade-up" data-aos-delay="200">
              <div class="slider-item">
                <a href="#" data-fancybox="{{asset('assets/images')}}')}}" data-caption="Caption for this image"><img src="{{asset('assets/images/slider-1.jpg')}}" alt="Image placeholder" class="img-fluid"></a>
              </div>
              <div class="slider-item">
                <a href="{{asset('assets/images/slider-2.jpg')}}" data-fancybox="{{asset('assets/images')}}" data-caption="Caption for this image"><img src="{{asset('assets/images/slider-2.jpg')}}" alt="Image placeholder" class="img-fluid"></a>
              </div>
              <div class="slider-item">
                <a href="{{asset('assets/images/slider-3.jpg')}}" data-fancybox="{{asset('assets/images')}}" data-caption="Caption for this image"><img src="{{asset('assets/images/slider-3.jpg')}}" alt="Image placeholder" class="img-fluid"></a>
              </div>
              <div class="slider-item">
                <a href="{{asset('assets/images/slider-4.jpg')}}" data-fancybox="{{asset('assets/images')}}" data-caption="Caption for this image"><img src="{{asset('assets/images/slider-4.jpg')}}" alt="Image placeholder" class="img-fluid"></a>
              </div>
              <div class="slider-item">
                <a href="{{asset('assets/images/slider-5.jpg')}}" data-fancybox="{{asset('assets/images')}}" data-caption="Caption for this image"><img src="{{asset('assets/images/slider-5.jpg')}}" alt="Image placeholder" class="img-fluid"></a>
              </div>
              <div class="slider-item">
                <a href="{{asset('assets/images/slider-6.jpg')}}" data-fancybox="{{asset('assets/images')}}" data-caption="Caption for this image"><img src="{{asset('assets/images/slider-6.jpg')}}" alt="Image placeholder" class="img-fluid"></a>
              </div>
              <div class="slider-item">
                <a href="{{asset('assets/images/slider-7.jpg')}}" data-fancybox="{{asset('assets/images')}}" data-caption="Caption for this image"><img src="{{asset('assets/images/slider-7.jpg')}}" alt="Image placeholder" class="img-fluid"></a>
              </div>
            </div>
            <!-- END slider -->
          </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="media media-custom d-block mb-4 h-100">
              <a href="#" class="mb-4 d-block"><img src="{{asset('assets/images/img_1.jpg')}}" alt="Image placeholder" class="img-fluid"></a>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="200">
            <div class="media media-custom d-block mb-4 h-100">
              <a href="#" class="mb-4 d-block"><img src="{{asset('assets/images/img_2.jpg')}}" alt="Image placeholder" class="img-fluid"></a>
              <div class="media-body">
                <span class="meta-post">February 26, 2018</span>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="300">
            <div class="media media-custom d-block mb-4 h-100">
              <a href="#" class="mb-4 d-block"><img src="{{asset('assets/images/img_3.jpg')}}" alt="Image placeholder" class="img-fluid"></a>
              <div class="media-body">
                <span class="meta-post">February 26, 2018</span>
